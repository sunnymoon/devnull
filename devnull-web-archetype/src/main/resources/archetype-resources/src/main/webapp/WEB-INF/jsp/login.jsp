...
<c:if test="${symbol_dollar}{not empty param.login_error}">
    <div class="row">
        <div class="alert alert-error">
            ...
            <ul>
                <li>
                    <c:out value="${symbol_dollar}{SPRING_SECURITY_LAST_EXCEPTION.message}"/></li>
            </ul>
        </div>
    </div>
</c:if>
        ...
        <ul class="thumbnails">
            <li class="span2">
                <div class="thumbnail">
                    ...
                    <a href="${symbol_dollar}{openIdUrl}">
                        <img src="${symbol_dollar}{pageContext.request.contextPath}/assets/images/logins/google.png" alt="Google">
                    </a>
                </div>
            </li>
            <li class="span2">
                <div class="thumbnail">
                    ...
                    <a href="${symbol_dollar}{openIdUrl}">
                        <img src="${symbol_dollar}{pageContext.request.contextPath}/assets/images/logins/yahoo.png" alt="Yahoo">
                    </a>
                </div>
            </li>
            <li class="span2">
                <div class="thumbnail">
                    <a href="${symbol_pound}">
                        <img src="${symbol_dollar}{pageContext.request.contextPath}/assets/images/logins/facebook.png" alt="Facebook">
                    </a>
                </div>
            </li>
            <li class="span2">
                <div class="thumbnail">
                    <a href="${symbol_pound}">
                        <img src="${symbol_dollar}{pageContext.request.contextPath}/assets/images/logins/twitter.png" alt="Twitter">
                    </a>
                </div>
            </li>
            <li class="span2">
                <div class="thumbnail">
                    <a href="${symbol_pound}"><img src="${symbol_dollar}{pageContext.request.contextPath}/assets/images/logins/live.png" alt="Live"></a>
                </div>
            </li>
        </ul>
    </div>
